...
export const domainStatusEnum = pgEnum("domain_status", ["active", "expired", "pending", "pending_activation", "transferred", "suspended", "cancelled", "pending_transfer", "grace_period", "redemption_period", "pending_delete", "client_hold"]);
