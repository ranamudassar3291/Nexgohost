...
export const clientRoutes: RouteDefinition[] = [
  ...
  { path: "/dashboard/hosting",     label: "My Hosting",  icon: Server,          inNav: true  },
  { path: "/dashboard/domains",       label: "My Domains",    icon: Globe,    inNav: true  },
  { path: "/dashboard/domain-search", label: "Domain Search", icon: Search,   inNav: false },
  { path: "/dashboard/billing",      label: "Billing",     icon: Receipt,         inNav: true  },
  { path: "/dashboard/invoices/:id", label: "Invoice",   icon: FileText,        inNav: false },
  { path: "/dashboard/orders",      label: "Orders",      icon: ShoppingCart,    inNav: true  },
  { path: "/dashboard/tickets",     label: "Support",     icon: Ticket,          inNav: true  },
  { path: "/dashboard/tickets/:id", label: "Ticket",      icon: Ticket,          inNav: false },
  { path: "/dashboard/migrations",  label: "Migrations",  icon: ArrowRightLeft,  inNav: false },
  { path: "/dashboard/orders/new",  label: "New Order",   icon: ShoppingCart,    inNav: false },
  { path: "/dashboard/checkout",    label: "Checkout",    icon: CreditCard,      inNav: false },
  { path: "/dashboard/account",           label: "My Account",      icon: UserIcon,        inNav: true  },
  { path: "/dashboard/affiliate",          label: "Affiliate",       icon: Share2,          inNav: false },
  { path: "/dashboard/credits",            label: "Credits",         icon: Wallet,          inNav: false },
  { path: "/dashboard/security",            label: "Security",        icon: ShieldCheck,     inNav: true  },
  { path: "/dashboard/team",               label: "Team Access",     icon: Users2,          inNav: true  },
  { path: "/dashboard/growth",             label: "SEO Toolkit",     icon: TrendingUp,      inNav: true  },
  { path: "/dashboard/domains/transfer",   label: "Transfer Domain", icon: RefreshCw,       inNav: false },
  { path: "/help",                       label: "Help Center",     icon: HelpCircle,      inNav: false },
];
