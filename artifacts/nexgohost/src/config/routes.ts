...
export const clientRoutes: RouteDefinition[] = [
  ...
  { path: "/client/orders",      label: "Orders",      icon: ShoppingCart,    inNav: false },
  { path: "/client/tickets",     label: "Support",     icon: Ticket,          inNav: true  },
  { path: "/client/tickets/:id", label: "Ticket",      icon: Ticket,          inNav: false },
  { path: "/client/migrations",  label: "Migrations",  icon: ArrowRightLeft,  inNav: false },
  ...
  { path: "/client/account",           label: "Account",         icon: UserIcon,        inNav: false },
  { path: "/client/affiliate",          label: "Affiliate",       icon: Share2,          inNav: false },
  { path: "/client/credits",            label: "Credits",         icon: Wallet,          inNav: false },
  { path: "/client/security",            label: "Security",        icon: ShieldCheck,     inNav: false },
  { path: "/client/team",               label: "Team Access",     icon: Users2,          inNav: false },
  { path: "/client/growth",             label: "Growth Suite",    icon: TrendingUp,      inNav: false },
