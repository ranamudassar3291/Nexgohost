    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                ...
                <tr key={ext.id} className="border-b border-border/50 hover:bg-secondary/20 transition-colors">
                  ...
                  <td className="p-4">
                    <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${
                      ext.status === "active" ? "bg-green-50 text-green-700 border-green-200" : "bg-secondary text-muted-foreground border-border"
                    }`}>{ext.status}</span>
                  </td>
                  <td className="p-4">
      ...
      <div className="bg-card border border-border rounded-2xl overflow-hidden">
        <div className="flex items-center gap-3 px-6 py-4 border-b border-border">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: "linear-gradient(135deg, #6B46C1 0%, #7C5DE2 60%, #8B5CF6 100%)" }}>
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2">
            ...
            <Button
              ...
              className="gap-2"
              style={{ background: "linear-gradient(135deg, #6B46C1 0%, #7C5DE2 60%, #8B5CF6 100%)", border: "none" }}
            >
