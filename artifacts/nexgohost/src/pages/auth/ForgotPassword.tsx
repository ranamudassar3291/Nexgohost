                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full h-11 px-4 rounded-xl border text-sm text-black placeholder-gray-400 outline-none transition-all focus:ring-2 focus:ring-[#6B46C1]/25 focus:border-[#6B46C1] bg-white ${fieldErr ? "border-red-400 bg-red-50" : "border-gray-200"}`}
                    />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full h-11 rounded-xl bg-[#6B46C1] hover:bg-[#5B36B1] text-white text-sm font-semibold transition-colors flex items-center justify-center gap-2 disabled:opacity-60 shadow-md shadow-[#6B46C1]/25"
                  >
                    {loading ? (
