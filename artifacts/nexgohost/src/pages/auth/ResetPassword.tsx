...
export default function ResetPassword() {
  ...
  const inputCls = (field?: "password" | "confirm") =>
    `w-full h-11 px-4 rounded-xl border text-sm text-black placeholder-gray-400 outline-none transition-all focus:ring-2 focus:ring-[#6B46C1]/25 focus:border-[#6B46C1] bg-white pr-11 ${
    ...
    <div className="min-h-screen w-full bg-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-12 h-12 rounded-2xl bg-[#6B46C1] flex items-center justify-center mb-3 shadow-lg shadow-[#6B46C1]/30">
          ...
          <AnimatePresence mode="wait">
            ...
            {!done && (
              <motion.div key="form" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
                <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-[#6B46C1]/10 mb-5">
                  <LockKeyhole size={22} className="text-[#6B46C1]" />
                </div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full h-11 mt-1 rounded-xl bg-[#6B46C1] hover:bg-[#4338CA] text-white text-sm font-semibold transition-colors flex items-center justify-center gap-2 disabled:opacity-60 shadow-md shadow-[#6B46C1]/25"
                  >
                    {loading ? (
                ...
                <div className="mt-5 text-center">
                  <a href="/forgot-password" className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#6B46C1] transition-colors">
