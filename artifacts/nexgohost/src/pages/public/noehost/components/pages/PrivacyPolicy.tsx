...
const PrivacyPolicy: React.FC = () => {
  ...
  const pgCms = content?.["pages.privacy"] || {};
  const pg = { title: 'Privacy Policy', lastUpdated: '', intro: '', sections: [], ...pgCms };
    ...
    <div className="min-h-screen bg-dark">
      <section className="relative bg-secondary overflow-hidden pt-36 pb-24">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-3xl">
          ...
          <h1 className="text-5xl font-black text-white mb-4">{pg.title || 'Privacy Policy'}</h1>
