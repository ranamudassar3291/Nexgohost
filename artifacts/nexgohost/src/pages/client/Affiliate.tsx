...
export default function Affiliate() {
  ...
  <text x="${width / 2}" y="${height * 0.62}" font-family="Inter,Arial,sans-serif" font-size="${Math.max(18, Math.round(height * 0.26))}px" font-weight="900" fill="#6B46C1" text-anchor="middle">Rs. 999/yr</text>
    ...
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      ...
      <Card className="border-purple-100 bg-gradient-to-br from-purple-50 to-white">
        <CardContent className="pt-6">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={copyLink} className="bg-[#6B46C1] hover:bg-[#4338CA] shrink-0">
      ...
      <Card>
        <CardContent className="pt-5 pb-5">
          ...
          <Progress value={progressPct} className="h-3 [&>div]:bg-[#6B46C1]" />
      ...
      <Card className="border-purple-200 bg-gradient-to-br from-[#0D0D1F] to-[#1A1040] text-white overflow-hidden">
        <CardHeader className="pb-3">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-[#6B46C1]/20 border border-[#6B46C1]/30">
              <Share2 className="h-5 w-5 text-[#6B46C1]" />
            </div>
            <div>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                onClick={copyLink}
                className="bg-[#6B46C1] hover:bg-[#4338CA] text-white shrink-0 gap-1.5"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                <button
                  ...
                  className="flex flex-col items-start gap-1.5 p-3 rounded-xl border border-[#2A2A4A] bg-[#0A0A1A] hover:border-[#6B46C1]/60 hover:bg-[#13132A] transition-all text-left group"
                >
                  <div className="flex items-center justify-between w-full">
                    <span className="text-xs font-semibold text-purple-200 group-hover:text-white transition-colors">{label}</span>
                    <Download className="h-3.5 w-3.5 text-[#6B46C1] opacity-70 group-hover:opacity-100" />
                  </div>
          ...
          {/* Motivational nudge */}
          <div className="rounded-xl border border-[#6B46C1]/30 bg-[#6B46C1]/10 px-4 py-3 text-center">
        ...
        <CardContent>
          ...
          {activePayoutTab === "wallet" && (
            <form onSubmit={handleWalletTransfer} className="space-y-4">
              ...
              <Button type="submit" disabled={walletLoading || availableBalance < 100} className="w-full bg-[#6B46C1] hover:bg-[#4338CA]">
          ...
          {activePayoutTab === "bank" && (
            <form onSubmit={handleBankWithdrawal} className="space-y-4">
              ...
              <Button type="submit" disabled={bankLoading || availableBalance < threshold} className="w-full bg-[#6B46C1] hover:bg-[#4338CA]">
