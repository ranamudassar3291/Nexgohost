...
export default function DomainManage() {
  ...
  const statusMap: Record<string, { label: string; cls: string }> = {
    ...
    grace_period: { label: "Grace Period", cls: "bg-purple-50 text-purple-700 border-purple-200" },
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {domain.isIn60DayLock && !domain.lockOverrideByAdmin ? (
                    <span className="text-xs px-2.5 py-0.5 rounded-full border font-semibold bg-red-50 text-red-600 border-red-200 flex items-center gap-1">
