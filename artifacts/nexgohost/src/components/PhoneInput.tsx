  ...
  return (
    <div ref={containerRef} className={`relative flex items-stretch ${className}`}>
      ...
      <input
        ...
        className="flex-1 h-11 px-3 rounded-r-xl border border-gray-200 text-sm text-gray-800 placeholder-gray-400 outline-none focus:ring-2 focus:ring-[#6B46C1]/25 focus:border-[#6B46C1] bg-white transition-all"
      />
          ...
          <div className="p-2 border-b border-gray-100">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-8 pl-7 pr-3 text-xs border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-[#6B46C1]/25 focus:border-[#6B46C1]"
              />
            </div>
          </div>
          {/* List */}
