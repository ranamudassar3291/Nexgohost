...
const footerLinks = [
  ...
  },
  {
    title: "COMPANY",
    links: [
      { label: "About Noehost",  href: "/contact" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Billing Support",  href: "/client/tickets" },
      { label: "Open a Ticket",    href: "/client/tickets" },
    ],
  },
];
...
export function SiteFooter() {
  return (
    <footer className="bg-[#0F172A] text-white pt-24 pb-12" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          <div className="lg:col-span-1 space-y-8">
            ...
            <p className="text-slate-500 text-sm leading-relaxed font-medium">
              Pakistan's premier web hosting provider with enterprise-grade infrastructure and 24/7 expert support.
            </p>
            ...
            <div key={column.title}>
              ...
              <ul className="space-y-4">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <Link href={link.href} className="text-slate-500 hover:text-primary text-sm font-bold transition-colors">
                      {link.label}
                    </Link>
                  </li>
                ))}
        ...
        <div className="pt-12 flex flex-col md:flex-row justify-between items-center gap-8" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <div className="flex flex-col md:flex-row items-center gap-6">
            <p className="text-slate-600 text-xs font-bold">
              © {new Date().getFullYear()} Noehost. All rights reserved.
            </p>
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center px-3 py-1.5 rounded-lg" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
              ...
              <div className="flex items-center justify-center px-2.5 py-1.5 rounded-lg" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
