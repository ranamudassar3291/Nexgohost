    ...
    <div className="flex items-center gap-3">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 14px rgba(107,70,193,0.35)",
      ...
      {showText && !logoUrl && (
        <div className="flex flex-col justify-center">
          <h1
            ...
            style={!textClassName ? { background: "linear-gradient(135deg,#6B46C1,#8B5CF6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" } : undefined}
          >
            {siteName}
          </h1>
          {subtext && (
            <p className="text-[10px] font-semibold tracking-widest uppercase mt-0.5" style={{ color: "#6B46C1" }}>
              {subtext}
            </p>
          )}
        </div>
